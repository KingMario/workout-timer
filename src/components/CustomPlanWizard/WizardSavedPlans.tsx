                    ...
                    {!isEditing && (
                      <>
                        <button
                          ...
                          className="px-3 py-1.5 bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-gray-300 text-sm rounded hover:bg-gray-200 dark:hover:bg-zinc-700 transition-colors group flex items-center gap-1.5"
                          title="复制 JSON"
                        >
                          <svg
                            className="w-3.5 h-3.5"
