...
export const DEFAULT_PLAN: WorkoutPlan = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        name: '鸟狗式',
        desc: '四足跪姿. 缓慢将对侧的手 and 腿向前向后伸直，与身体成一直线，保持核心收紧身体稳定，缓慢收回. 换边。',
        duration: 45,
      },
      { name: '休息', desc: '', duration: 15 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      {
        name: '腹式深呼吸',
        desc: '坐 or 躺，一手放腹部. 用鼻子缓慢吸气4秒，感受腹部鼓起；用嘴巴缓慢呼气6秒，感受腹部收紧. 重复。',
        duration: 30,
      },
    ],
  },
